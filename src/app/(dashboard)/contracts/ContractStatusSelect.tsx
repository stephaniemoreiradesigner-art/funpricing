  ...
  return (
    <div className="relative inline-block">
      <select
        ...
        className={`appearance-none text-xs font-semibold px-2.5 py-1 rounded-full border-0 cursor-pointer focus:outline-none focus:ring-2 focus:ring-[var(--brand)] disabled:opacity-60 ${current?.color}`}
      >
